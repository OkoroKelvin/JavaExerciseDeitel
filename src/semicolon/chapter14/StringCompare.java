...
public class StringCompare {
    public static void main(String[] args) {
        ...
        System.out.printf("s1 = %s%ns2 = %s%ns3 = %s%n%n", s1,s2,s3,s4);
        // test for equality
        if(s1.equals("hello"))
        ...
        System.out.printf(
                "%ns1.compareTo(s2) is %d",s2.compareTo(s1));

        System.out.printf(
                "%ns1.compareTo(s2) is %d",s1.compareTo(s1));

        System.out.printf(
                "%ns1.compareTo(s2) is %d",s3.compareTo(s4));

        System.out.printf(
                "%ns1.compareTo(s2) is %d",s4.compareTo(s3));
