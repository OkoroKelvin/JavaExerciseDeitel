...
@Test
    public void testToSetAndGetDayOfDate(){
        calender.setDayDate(22);
        assertEquals(22,calender.getDayDate());
}

@Test
    public void testToSetAndGetYear() {
        calender.setYearDate(2019);
        assertEquals(2019, calender.getYearDate());
    }

    @Test
    public void testToDisplayDate(){
   calender.displayDate();
   assertEquals(22,calender.displayDate());
    }
